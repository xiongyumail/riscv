...
#
# Generated by Vivado on Wed Mar 10 03:38:20 +0000 2021
...
compile()
{
  ...
  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"$ref_dir/../../../ipstatic" \
    "$ref_dir/../../../../tinyriscv_vcu118.srcs/sources_1/ip/clk_wiz_0/clk_wiz_0_clk_wiz.v" \
    "$ref_dir/../../../../tinyriscv_vcu118.srcs/sources_1/ip/clk_wiz_0/clk_wiz_0.v" \
  2>&1 | tee -a vlogan.log
...
create_lib_mappings()
{
  ...
  if [[ ($1 != "") ]]; then
    ...
    lib_map_path="/home/vitis/projects/tinyriscv_vcu118/tinyriscv_vcu118.cache/compile_simlib/vcs"
  fi
