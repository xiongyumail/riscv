...
proc create_root_design { parentCell } {
  ...
  set riscv_jtag_TDI [ create_bd_port -dir I riscv_jtag_TDI ]
  set riscv_jtag_TDO [ create_bd_port -dir O riscv_jtag_TDO ]
  set riscv_jtag_TMS [ create_bd_port -dir I riscv_jtag_TMS ]
  set riscv_sysled [ create_bd_port -dir O riscv_sysled ]
  set riscv_uart_debug_pin [ create_bd_port -dir I riscv_uart_debug_pin ]
  ...
  connect_bd_net -net jtag_TCK_0_1 [get_bd_ports riscv_jtag_TCK] [get_bd_pins tinyriscv_soc_top_0/jtag_TCK]
  connect_bd_net -net jtag_TDI_0_1 [get_bd_ports riscv_jtag_TDI] [get_bd_pins tinyriscv_soc_top_0/jtag_TDI]
  connect_bd_net -net jtag_TMS_0_1 [get_bd_ports riscv_jtag_TMS] [get_bd_pins tinyriscv_soc_top_0/jtag_TMS]
  ...
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins tinyriscv_soc_top_0/sysclk]
  connect_bd_net -net processing_system7_0_FCLK_RESET0_N [get_bd_pins processing_system7_0/FCLK_RESET0_N] [get_bd_pins tinyriscv_soc_top_0/sysrst]
  ...
  connect_bd_net -net tinyriscv_soc_top_0_sysled [get_bd_ports riscv_sysled] [get_bd_pins tinyriscv_soc_top_0/sysled]
  ...
  connect_bd_net -net uart_debug_pin_0_1 [get_bd_ports riscv_uart_debug_pin] [get_bd_pins tinyriscv_soc_top_0/uart_debug_pin]
  connect_bd_net -net uart_rx_pin_0_1 [get_bd_ports riscv_uart_rx_pin] [get_bd_pins tinyriscv_soc_top_0/uart_rx_pin]
